		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapzfioritraining-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapzfioritraining-display": {
								"semanticObject": "comsapzfioritraining",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.zfioritraining",
									"url": sap.ui.require.toUrl("com/sap/zfioritraining")
								}
							}
						}
					}
